...
describe('IdemEvaluator', () => {
    ...
    it('resolves self properties', () => {
        ...
        expect(evalExpr('self.nonExistent')).toBeUndefined();
    });
    ...
    it('handles arithmetic operators', () => {
        ...
        expect(evalExpr('self.a + null')).toBeNull();
    });
    ...
    it('handles in operator', () => {
        ...
        expect(evalExpr('null in self.items')).toBe(false);
    });
    ...
    describe('Built-in Functions', () => {
        ...
        it('handles temporal literals and functions', () => {
             expect(evalExpr('`2023-12-31`')).toEqual(new Date('2023-12-31T00:00:00.000Z'));
